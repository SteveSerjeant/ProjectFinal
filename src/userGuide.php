    ...
    <div class="document">
        ...
        <div class="intro">
            <p>
                ...
                computer that use specific "ports" on the device to exchange information with outside entities through the broadband connection.
        ...
        <div class="mainText">
            <p>
                ...
                credentials. A banner indicating success was shown and the user was then prompted to enter their details to login to the system.
            </p>
            <p>
                ...
                A scan would have to be performed to initially populate teh database and tables. The header also includes a navigation bar which will perform
                functions or take the user to other parts of the system. These will be explained in further sections.
            </p>
            <p>
                ...
                updated and refreshed from the database everytime a button or link is clicked therefore the most up-to-date information is always available. The
                system is set-up to automatically perform a scan every two weeks on a Sunday or as soon as possible after this when the computer is active.
            </p>
            <p>
            ...
            <p>
                ...
                passwords pass the password criteria the database is updated, the user is returned to the home page and a message bar indicated the password has been
...
<!--    weird! did not display the following div, BUT did display the scroll bar for the above div, then commented out the contents-->
